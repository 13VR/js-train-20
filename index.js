...
Truck.prototype.tow = function (weightToTow) {
  this.specific(weightToTow);
};
...
Car.prototype.drive = function (kilometersIncrease) {
  this.kilometers = 0;
  this.kilometers += kilometersIncrease;
  console.log(
    `Подорожуємо ${this.kilometers} кілометрів у ${this.brand} ${this.model}`
  );
};
const driveCar = newCar.drive.bind(newCar);
...
const newElCar = new ElectricCar("Tesla", "Model S", 2020, 10000, 100);
